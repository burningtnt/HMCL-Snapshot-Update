...
public final class TrustedLookup {
    ...
    private static final MethodHandles.Lookup INSTANCE = MethodHandles.publicLookup();

    public static MethodHandles.Lookup getInstance() {
        if (INSTANCE == MethodHandles.publicLookup()) {
    ...
    static {
        try {
            ...
            try (Arena ARENA = Arena.ofConfined()) {
                ...
                MemorySegment targetJClassArgument0 = ARENA.allocateFrom(TrustedLookup.class.getName());
