...
public final class BMIUploader189 implements IUploader {
    public BMIUploader189() {
    }
    ...
    public IUploadAction build(Path file, ArchiveFile info, SourceBranch source) {
        return new IUploadAction() {
            ...
            public URI getResult() throws URISyntaxException {
                return new URI("https://alist.8mi.tech/d/HMCL/189/" + info.getFileHash() + '/' + info.getFileName());
            }
        };
    }
